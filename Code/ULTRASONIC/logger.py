...
# Write the header row
    writer.writerow(['Timestamp', 'Distance (inches)'])
    ...
    while True:
        ...
        print('PingTravelTime = ', pingTravelTime, 'Distance = ', round(dist_inch, 1),'inches |', round(dist_cm, 1),
          'cm')
        writer.writerow([pingTravelTime, dist_inch])
        file.flush()
